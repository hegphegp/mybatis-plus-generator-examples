...
public class TableInfo {
    ...
    private final Set<String> importModelPackages = new HashSet<>();
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            ...
            for (TableField field : fields) {
                if (null != field.getColumnType() && null != field.getColumnType().getPkg()) {
                    ...
                    importModelPackages.add(field.getColumnType().getPkg());
                }
                if (field.isKeyFlag()) {
                    // 主键
                ...
                if (null != field.getFill()) {
                    ...
                    importModelPackages.add(com.baomidou.mybatisplus.annotation.FieldFill.class.getCanonicalName());
                }
            }
        }
        return this;
